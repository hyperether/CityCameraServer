...
/**
 * @api {post} /file/{userId}/getUploadURL
 ...
 * @apiUse badRequest
 */
router.get('/folders/:userId', secMidd.checkTokenUser, controller.folders);
 ...
 * @apiUse badRequest
 */
router.get('/:userId/:folder/files/', secMidd.checkTokenUser, controller.files);
